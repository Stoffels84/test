...
with locatie_tab:
    ...
    ok = True  # guard zodat we nooit st.stop() gebruiken
    ...
    if ok:
        # ---- Aggregaties per locatie (géén coachingberekeningen) ----
        agg = (
    ...
    if ok:
        ...
        # ---- Samenvatting per locatie (zonder % coaching) + export ----
        ...
        # ---- Detail per locatie (géén coaching-info) ----

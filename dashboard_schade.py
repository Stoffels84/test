...
def run_dashboard():
    ...
    with opzoeken_tab:
        ...
        # Data voor dit PNR binnen huidige filters en in volledige dataset
        ...
        # Status uit coachingslijsten (lopend/voltooid/…)
        ...
        # Datums coaching (met kleurtjes waar mogelijk)
        coaching_rows = []
        ...
        # Resultatentabel (huidige filters)
